...
public class SelectDinning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_dinning);
        ...
        furnitureTitle=(TextView)findViewById(R.id.txtitledin);
        furnituredesc=(TextView)findViewById(R.id.txtdescdin);
        //furnitureprice=(TextView)findViewById(R.id.txtprice);
        img=(ImageView)findViewById(R.id.selectimagedin);
