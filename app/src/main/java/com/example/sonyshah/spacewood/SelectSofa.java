...
public class SelectSofa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_sofa);

        getSupportActionBar().setTitle("Sofa");
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        furnitureTitle=(TextView)findViewById(R.id.txtitlesofa);
        furnituredesc=(TextView)findViewById(R.id.txtdescsofa);
        //furnitureprice=(TextView)findViewById(R.id.txtprice);
        img=(ImageView)findViewById(R.id.selectimagesofa);
